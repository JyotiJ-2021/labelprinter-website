...
image_carousel.owlCarousel({loop:true,nav:false,dots:true,margin:30,items:1,navText:["<i class=\'fal fa-angle-left\'></i>","<i class=\'fal fa-angle-right\'></i>"],})
...
/*PRODUCT DETAILS*/
$(document).on('click','.vallOffers',function(){
	$('.offer-bg').show();
	$('.offerView').show();

});
$(document).on('click','.offer-cls',function(){
	$('.offer-bg').hide();
	$('.offerView').hide();
});
